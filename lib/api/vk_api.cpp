...
std::vector<vk::_param_type> vk::api::vk_api::params(std::vector<vk::_param_type> parameters){
...
vk::api::vk_api::vk_api(){
	simdjson::dom::parser parser;
	simdjson::dom::element json = parser.load("../config/config.json");
